                ...
                if account<int(Time):
                    ...
                    if account_accept>0:
                        ...
                        if account == 1:
                            ...
                            self.send(address_list,"Winner",result_list[account-2][0],result_list[accout-2][1],Good_Id)
                            print("result of price",result_list[account-2][1])
                            for i in range(Number_of_agent):
                                Agent_list[i].process_data(address_list)
                            acution_flag=1
                            English_flag=0
                            self.Good_list[Good_Id][1].change_owner_Id(result_list[account-2][0],address_list)
                            self.Good_list[Good_Id][1].print_owner_Id()
                            for i in range(Number_of_agent):
                                if Agent_list[i].Id==result_list[account-2][0]:
                                    Agent_list[i].pay(result_list[account-2][1])
                ...
                if account<int(Time):
                    ...
                    if  account_accept==0:
                        ...
                        if account_accept == 1:
                            ...
                            self.Good_list[Good_Id][1].print_owner_Id()
                            for i in range(Number_of_agent):
                                if Agent_list[i].Id==Turn_winner:
                                    Agent_list[i].pay(price)
                        else:
                            price=price*1.2
                            n=random.sample(list(set(same_list)), 1)
